...
8. **Plot-importance inflation.** Firing because the writer knows the beat is load-bearing for the season. Tensometer reads on-face charge; narrator-interest reads on-face *attention*. A plot-load-bearing beat that does not carry her attention is correctly silent.
