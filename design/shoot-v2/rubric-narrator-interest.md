...
11. **Apparatus-as-subject registration (DEC-0115 / PROP-0046, 2026-06-08).** A narrator-interest entry whose grammatical subject is the apparatus, process, or lens — the feed, the count, the cost-register, the insect-network, the swarm — rather than a concrete actor or the narrator's concrete perception. *"The feed flags the contact"* — apparatus-as-subject; reject. *"The count closes on him"* — apparatus-as-agent; reject. *"The node forecloses the route"* — apparatus performing the event; reject. Correct form keeps the apparatus as a lens through which the narrator perceives a concrete event: *"she had already clocked the gap; the wing-shift confirms three left"* (the insect-channel is the perceptual tool, not the grammatical subject); *"the watch-cost has just been priced to her name"* (cost-tracking vocabulary, but the subject is the cost, a registered fact, not a process performing an action). Rule of thumb: if you can ask "who physically did the thing the entry describes?" and the answer is a system-process rather than a living actor, the entry is apparatus-as-subject. DEC-0115 retired the ledger/apparatus register at the bone layer (ABSTRACTION-AS-SUBJECT HARD at `/and-write` Phase 6); this AP closes the facet-layer re-entry vector — an author who bones concretely and then fires an apparatus-registered NI entry at the same bone has introduced the banned register through the facet door.
