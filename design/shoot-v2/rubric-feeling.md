...
18. **Apparatus-as-somatic-tell (DEC-0115 / PROP-0046, 2026-06-08; post-lock addition 2026-06-12).** A feeling-flag entry whose somatic-tell clause reports an apparatus-process or lens-event rather than a body action. *"taylor: the count settles in her"* — apparatus vocabulary; refuse. *"taylor: the network hums in her hands"* — apparatus-as-body-proxy; refuse. The somatic tell is a body action — the character's body, gesture, posture, breath, or micro-action — not the response-of-the-apparatus to the body. Distinguishing test: substitute any non-powered character for the slug; if the somatic tell becomes physically incoherent, the entry is apparatus-vocabulary, not body-register. Correct form isolates the body: *"taylor: her grip tightens on empty air"* (body-action; apparatus absent from the clause). DEC-0115 closed apparatus-as-subject at the bone layer (ABSTRACTION-AS-SUBJECT HARD at `/and-write` Phase 6) and the NI layer (AP-11 in rubric-narrator-interest); this AP closes the feeling-flag re-entry vector — an author who bones concretely and fires apparatus-vocabulary at the feeling layer has introduced the banned register through the somatic channel.
