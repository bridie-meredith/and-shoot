...
*"The shard incident proves: the Furnace Sect's product produces advancement when the cauldron is prepared to process it. The sect's method (refine fire externally; cast it outward) is the inferior technique; my method (refine fire internally; process it through the cauldron) is the correct application of the fire principle to body cultivation. Foundation Establishment was achieved through the Furnace Sect's product processed by the Cauldron-belly. The irony is not lost. The sect rejected me; their reagent advanced me. This is consistent with the genre's 'inheritance without acceptance' pattern."*
