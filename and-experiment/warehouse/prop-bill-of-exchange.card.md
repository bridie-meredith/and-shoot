...
A standard Braavosi commercial instrument — heavy paper (vellum or well-processed rag paper; not parchment, which is an older Westerosi form), written in careful mercantile script. Dimensions: roughly the size of a letter-sized page but slightly narrower, designed to fold in thirds for courier pouch transport.
...
- The weight of a completed bill is not much — a folded sheet — but the account-book where they are recorded is heavier; the stack of completed bills filed at the back of the book has a specific smell (lamp-oil, ink, the faint trace of the factor's counting-house if he returns a copy with his acknowledgment notation)
- Writing a bill: the scratch of her quill across good paper, deliberate, even-paced; she does not rush bills; each weight specification is double-checked before the ink is dry
- The factor's handwriting on the acknowledgment copy (which he returns with delivery) is very different from hers — large, commercial, abbreviated in a Braavosi clerk's style; the contrast between the two hands on the same document is the paper's own record of the relationship
- The first bill: written in the still-room, candle-light, at age six; the handwriting is careful but the hand is smaller than it will become; visible in the account-book archive as the founding document, the one that reads slightly more carefully than all the later ones
...
Folded in thirds; fits in a document wallet, a coat interior, or the account-book's pocket. Light. The standing-license reference makes it legally significant; she handles it accordingly — not carelessly. A bill left in the wrong hands would raise questions she does not want raised before Lock I is resolved.

---

## Functional State

**Active (Bk I.2 through Bk II.10):** The bill-of-exchange is the network's daily operational instrument. New bills are drafted as orders are placed. The factor fills them. The network expands.
