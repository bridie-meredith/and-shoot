# bones — b01c05 with [narrator:<id>] citations
...
5 the provisioner-train takes the east-lane [narrator:1]
6 the message-runner crosses the junction
7 the message-runner takes the lane-mouth [narrator:2]
...
13 the side-alley returns the sound [narrator:3]
...
18 taylor-hebert-kl-122ac adds the courier to the body-map [narrator:4]
...
25 taylor-hebert-kl-122ac stops the rushwick-pass [narrator:6]
26 taylor-hebert-kl-122ac closes the evening review
27 taylor-hebert-kl-122ac files the courier body-record [narrator:7]
