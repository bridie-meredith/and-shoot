...
flagged: 13
accepted: Prologue trio (all three italic paragraphs) earns its register — "Tya who came back wrong. They weren't wrong about the wrong part." is the correct entry point; no relief beat anywhere; log-trio pattern holds through every scene close; scene-A trifecta (bowl-has-been-waiting, chin-on-its-own, I-didn't-write-what-it-had-cost-my-mother) is earned; scene-C three-note-song cessation and "there wasn't any more daughter left in me for her to look at" are the episode's two strongest prose moments; scene-H departure-trio (mother facing door, father keeping eyes on work, gate crossed without return gaze) lands correctly as irreversible; maester's "hand reached the record-table before his gaze left the south wall" is body-cost detail done right; scene-N close ("the first thing I'd said in this city that I couldn't take back") is earned and correctly not catharsized.
why: The structural register holds throughout. The episode's two persistent problems: (1) inline parenthetical glosses — reeve, lord's-man, gold cloaks, maesters — break the first-person threat-assessment register by switching to social-explanation mode. Taylor does not explain institutions to the reader; she reads them as threat. The gloss mode was flagged at s01e02 wrap and it is present here first, indicating a systemic tic that predates e02 and the editor should treat as a pattern, not a one-off. (2) Environmental flatness in the Flea Bottom scenes — scene-I and scene-K give correct operational procedure but the city does not yet feel dangerous or real at the body level. One sensory detail that would not appear in Taylor's archive knowledge of the city — something the body gets wrong because it is calibrated to a village — is absent throughout. The vibes file calls for Flea Bottom as operational-territory-open; the prose delivers the open without the territory's pressure.

Additional: scene-B (yard perimeter sweep) is the episode's flattest passage — flat-low by design but with nothing in the execution that costs the reader attention. One detail of hostile-world texture (a neighbor's window, an animal reaction, something the yard smells like in a body that didn't grow up here) would rescue it without changing the scene's rhythm shape.

Escalated from s01e02 STM: The inline-tutorial/parenthetical-gloss problem has now appeared in both episodes. This is a systemic issue in the prose, not a per-scene correction. The editor should address it as a pattern: every parenthetical that reads as "character X was [institutional definition]" is a candidate for removal or conversion to inferred-from-behavior.

New watch: "A city I had already named, in a season I had not yet reached" — the foreknowledge framing at scene-I open risks reading as wry control rather than body-cost weight. The tone-law is foreknowledge-clamped slow-burn. Monitor in s01e02+ whether Taylor's narrative voice continues to treat foreknowledge as clever rather than as burden. If it repeats, it becomes a register drift flag.

## Wrap review s01e03 — 2026-05-13
flagged: 10 (3 high-severity, 4 medium, 3 low)
accepted: Displacement-clamp register surfaces textually across the episode as required — NI-augmentation discipline honored in most key beats. Father-elder-log triangle is the season's best character architecture. Maester-pen sequence and Taylor-maester parallel-documentation axis earn their weight. Log-trio accumulation is working. Season closes on asymmetry, not catharsis — no relief beat. Tanner-elder relationship stays conditional throughout (no warmth-drift).
why: Three high-severity flags all cluster in scene-H and scene-K — the heaviest conceptual weight concentrated in those scenes has produced two instances of grammar/referent collapse under compression (flag-002: "the interior had the count of years" is broken; flag-003: "two open columns on the same page" while Taylor faces a wall is physically ambiguous and threatens the season-close landing) and one POV-gloss recurrence (flag-001: "the Red Keep — the king's castle above the city" is the same em-dash tutorial-insert fault from s01e02, not yet resolved). Medium-severity flags form a related cluster around structural template-reuse: scene-C and scene-F share consecutive approach-exchange-departure architecture (flags 004, 005), and the scene-H wake-recovery echo of scene-B drops the sensory specificity that made scene-B land (flag-006). POV-gloss fault (flag-001) is a carry-forward from s01e02 wrap — appearing in different form confirms it is a systemic register-discipline problem, not an isolated sentence. Editor's primary task: clarify scene-H and scene-K displacement-clamp passages without warming; cut the POV gloss; differentiate consecutive template-echo scenes at the sensory level.
verdict: ACCEPT-WITH-FLAGS
carry-forward to s01e04+: POV-gloss fault is now confirmed systemic — two episodes, different locations, same em-dash tutorial structure. If it appears in s01e04, it escalates from flag to demand. Clinical register is holding architecturally; execution pressure shifts to preventing compression-collapse in peak passages as the apparatus plot thickens.
