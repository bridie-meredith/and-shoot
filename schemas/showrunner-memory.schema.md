...
books:
  - slug: b01                              # auto-generated by /and-substance series Phase 6
    ...
    consecutive_shipped_with_caveats: <int>  # default 0. PROP-0037. Maintained by /and-stitch Phase 9 Step 4:
                                           # +1 on a PASS-WITH-DEPTH-PASS-REQUIRED ship, reset to 0 on clean PASS.
                                           # Read by /and-substance chapter Phase 0 step 6.5 (HARD-abort at >= 3 unless acknowledged).
    cohere_acknowledgment:                 # nullable. PROP-0037. Stamped by /and-cohere Phase 7 on completion,
                                           # or manually by the principal to license one bypass of the step-6.5 gate.
      acknowledged_at: <iso-timestamp>     # valid for ONE chapter production run only; does not reset the counter
      acknowledged_by: <principal>
      reason: <one line>                   # why /and-cohere is deferred (manual stamp) or "auto: /and-cohere completed <range>"
    chapters:
