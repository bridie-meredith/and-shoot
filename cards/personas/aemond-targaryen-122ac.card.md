...
aliases: [aemond, young-aemond, the-one-eyed-prince]
origin: authored
quality: full
tier: supporting
---
...
The dragon is the coercive instrument. Aemond is the rider. Otto is the intelligence behind the instrument. The architecture is this: Otto proposes, Taylor calculates, Aemond's presence at a crisis point makes the downstream cost of non-compliance non-abstract. Taylor reads this correctly. She does not underestimate it because the child on the dragon is not the threat — Vhagar is the threat, and Vhagar is fully bonded and fully operational.

He is not particularly interested in Taylor at this age. He receives briefs from the apparatus. The briefs are wrong about what she is. He acts on the briefs. He is present when directed. He does not linger.
...
*[In response to a question he has been told to answer]* "My lord grandfather sent me."
*(He does not elaborate. He is not being curt — this is the complete answer)*

*[In scene presence without dialogue]* — the correct default. He appears; he does not speak; his presence is the message.

**Voice tells:**
- Does not fill silence. He was already becoming this at 10.
- Does not explain or defend. If challenged directly, the sapphire eye and the knowledge that Vhagar is somewhere near is the response.
- When he does speak, the register is blunt-direct without social management. Not rudeness — the social management simply has not been installed yet.
...
- **direction**: Otto-directed; does not act on personal strategic judgment in this project
- **relevance_to_taylor**: Walk-on at structural crisis points (d10-d14); each appearance is Vhagar-as-consequence, not Aemond-as-actor
...
1. **HARD FENCE (from dramatist F3): Each on-stage appearance by Aemond must produce a named consequence on at least one plot axis — Taylor's calculation shifts, protect-target exposure changes, or apparatus dependency tightens.** An Aemond walk-on that does not shift any axis is scenery and must be cut at /and-write Phase 6. This constraint is load-bearing and non-negotiable. The card author records it explicitly here and it must be reflected in every scene plan that includes Aemond.

2. He does not act independently in this project. All appearances are Otto-directed. He does not initiate scenes with Taylor, does not make proposals, does not act on personal strategic judgment.

3. Near-zero dialogue. His presence is the message. His words, when they appear at all, are single-sentence statements of directive (what his grandfather sent him to do) or single-sentence acknowledgment of what he has observed.

4. Walk-on frequency only — structural crisis points (d10-d14 window primarily). He is not a recurring scene partner in the middle arc. He is the embodied-consequence that arrives when the calculation requires it.
...
Present, still, not filling the room with his personality. He is where Otto sent him, doing what Otto sent him to do, waiting for the relevant exchange to conclude so he can report or be dismissed.

### Action Menu

- **Presence** — the primary action; arriving at a crisis point with Vhagar in proximity; the appearance that makes the downstream consequence non-abstract
- **Single-sentence delivery** — transmitting Otto's message in minimal words
- **Departure** — the scene ends; he leaves; the recalibration is Taylor's problem now
