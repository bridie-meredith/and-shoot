---
name: cond-alchemists-guild-122ac
class: condition
scope: library
world: planetos
origin: authored
...
Scenes set near or inside Guild territory carry:
- Fire and sulfur: the ambient smell of the Guild's working spaces; sulfur is a constant; beneath it the green-chemical sweetness of wildfire preparation (distinguishable from other fire-smells if one knows what wildfire smells like)
- A particular quality of orange-yellow lamp-light in the Guild's workrooms — they do not use candles near active preparations; the lamps are sealed; the light has a warmer and more stable character than open flame
- A bureaucratic layer: the Guild keeps records, has formal admission processes, issues statements. An encounter with the Guild involves paperwork alongside any other interaction
...
**The post-incident non-inquiry.** The Guild did not investigate the shard's disappearance from the storage container. The container held many fragments; the specific one she took was small; the Guild's records of preparation-batch quantities are not grain-weight precise. She was careful. The Guild's one formal interaction with the incident was a diplomatic note to the Maester's Tower indicating that the princess had visited and that the Guild hoped no materials had been accidentally mishandled. This was received, filed, and not acted on. The maester showed it to the septa. The septa filed it as confirmation of what she already believed: the princess requires more supervision.

---

## Real Properties of Wildfire
...
**Magical component:** Wildfire is a manufactured magical substance — not explainable by mundane medieval chemistry. Its production apparently requires or is enhanced by magical input — there are references suggesting wildfire production was more reliable when living dragons were in Westeros (magic levels higher), and became less reliable after dragon extinction. The Guild guards its process with absolute secrecy; even other maesters do not know the composition. `[canon-uncertain: exact relationship between dragon/magic levels and wildfire production; exact composition]`

**Toxicology:** Wildfire at non-trivial ingested doses is acutely toxic by both chemical and magical mechanisms. It is not food. It is not a medicine. It is not a safe experimental reagent at any realistic dose. A 0.3 grain-weight solid fragment was small enough to produce a survivable toxic reaction rather than immediate death; it was not small enough to produce a controlled or predictable one.

**The Dance connection:** Wildfire features prominently in the Dance of the Dragons — it is used during the battle at the Dragonpit, contributing to the burning that kills dragons and thousands in King's Landing.

---

## Her Cultivation-Register Reading (Belief Column)

She classifies the Alchemists' Guild as "the Furnace Sect" — a fire-attribute cultivation sect operating openly in King's Landing as a guild of craftsmen. Her analysis:

*"The Furnace Sect practices a form of fire-attribute alchemy that has produced one confirmed magical-tier reagent (wildfire, Tier 3). Their refusal to admit petitioners from outside the hereditary succession indicates a closed-lineage sect structure — their cultivation method is blood-transmitted, which is consistent with the guild's observation that production quality correlates with practitioner bloodline. Their product demonstrates genuine fire-attribute qi-crystallization; a maester who studies the product would, if they had the correct framework, recognize it as a Tier-3 fire-attribute pill in liquid form."*

*"My application for admission was declined. I assess the rejection as follows: the Furnace Sect requires fire-bloodline aptitude for admission, which is demonstrated through practical fire-cultivation capacity. I do not have dragon-blood-fire activation (my cultivation is Cauldron-belly, not Flame-body), and the sect's assessment instruments would not recognize the Cauldron-belly path as fire-cultivation. Their rejection is technically correct by their own sect's framework and does not reflect on the cauldron's actual tier or capacity."*

**Real-state column:** The Guild makes wildfire. Their rejection of her petition was appropriate — she is a child with no pyromantic aptitude who showed up and asked to learn their trade secret. The shard incident was a toxic-and-magical reaction, not an advancement. The Guild did not advance her. She survived their product at a small dose. These are different things.
...
- **With the Dance (Book III):** The wildfire used in the Dance is the same institution's product at scale. The comedy-that-curdles dimension: the Tier-3 "fire-attribute reagent" that produced the shard incident as a thumbnail fragment is the same substance that burns the Dragonpit. The cultivation-register's accounting treats both events as involving the same material. The reader does not.
