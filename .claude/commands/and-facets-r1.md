---
description: Round 1 only — blind authoring of the nine tuned facet authors against one episode's proto-lines in DAG order. Sub-step of the master /and-facets chain; callable standalone for explicit Round-1-only runs. Output - active-project/theater/facets/. Usage - /and-facets-r1 [episode-slug]
---

Round-1 facet authoring against one episode's bones. Step A of the Beta three-round pipeline (`design/shoot-v2/three-pass-alpha-design.md`).
