...
**Precondition:** Phase 5 = 0 HARD AND Phase 5b = ACCEPT (3-of-3 per facet, all ten facets including exposition, AND 3-of-3 per character dialogue file). If either gate is unclean, do not persist — return to the appropriate phase.
