...
## Bullet 1 — taylor-hebert-westeros (POV on STUDIO open) — yard-tableau
attempts: 2 | outcome: retried
- attempt 1: pulp-enthusiast rejected — frozen tableau on a live board, no clock-start, no board change inside the line
- attempt 2: all three accepted — opened at the violated door (someone came while she was gone) as the operative fact; settlement-as-vote framing landed as escalation

## Bullet 2 — taylor-hebert-westeros — recorder-window-named
attempts: 1 | outcome: clean

## Bullet 3 — septon-rowan — writes-regardless
attempts: 1 | outcome: clean

## Bullet 4 — taylor-hebert-westeros — document-on-threshold-stone
attempts: 1 | outcome: clean
...
## Bullet 6 — STUDIO cart arrival (Taylor POV) — circuit-cadence-chime
attempts: 2 | outcome: retried
- attempt 1: pulp-enthusiast rejected — ~360 words of perceptual arrival, board identical at end of paragraph to start; filler texture while the live plot has two unaddressed claims and a Citadel letter incoming
