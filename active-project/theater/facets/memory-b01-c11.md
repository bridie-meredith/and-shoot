...
chapter: b01c11
prefix: mem
author: impersonator (taylor-hebert-kl-122ac) — Phase 1 R1, facet-authoring override mode
rubric: design/shoot-v2/rubric-memory-flags.md (V3 locked 2026-05-21)
scene-map: theater/facets/scene-map-b01-c11.md (locked, upstream)
spine: NOT-YET-RESOLVED (parallel R1 fork — narrator-interest + feeling files not authored at author-time; co-citation deferred to cross-facet contract check, Phase 4/5)
density: 2 fires / 27 bones = 7.4% (within 5-12% chapter band)
