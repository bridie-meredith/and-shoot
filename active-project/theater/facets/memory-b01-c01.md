...
# Memory-Flags — b01c01
# 27 bones. Sparsity target: 1-5% = 0-1 entries.
# All three scenes are rhythm-shape: flat-low (inverted-pressure-signal: licit zone).
# Chapter dramatic_shape: hinge. All scenes have stakes_axis: capability in axes_held[].
# V3 feel-as-spine carve-out available for all bones: all four conditions checkable.
# Doubled-register: Earth-Bet displacement AND Westerosi-monument clamp both required.
#
# Per-scene cap: ≤1 per scene.
# Monument inventory per taylor-hebert.card.md and taylor-hebert-kl-122ac.card.md.
#
# SCENE A (@1-9) — candidate: @9 (holds-feet held bone; the inverted establishing fact)
# SCENE B (@11-20) — candidate: @16 (holds-hands held; Khepri's hands as instrument)
# SCENE C (@22-29) — candidate: @26 (Wren's flies-observation; or @29 closing held)
#
