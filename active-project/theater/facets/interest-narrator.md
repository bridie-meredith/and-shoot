...
3 @13 she does not deploy anything new; the elders are already in the long-pattern record as nodes — meeting-frequency, errand-direction, who they receive instruction from — and the ask is only that she convert nodes to names, which is the step the record has been waiting four months for her to take.

4 @22 the seal is the breach; the accounting ran clean, both arms at full weight, and arrived here exactly as the framework produces when the terms are stated and the premise is wrong.
...
6 @12 she reopens to confirm what unit the ask wants, and the unit has changed under her hand — a node holds frequency and heading and who-receives-instruction, a name holds a body the heading can find; she has moved bodies along a record before, and the record was always the route.
