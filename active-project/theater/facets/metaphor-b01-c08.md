...
# refuse-rationale
#
# b01c08 is a held-axis-dominant staging chapter. Capability +0.5 at scene-A
# is the sole axis-move across 24 bones. All other axes held across all three
# scenes. The rubric's discipline default (zero fires) is the correct output.
#
# Sparsity ceiling: 0-3% of 24 bones = 0-1 entries.
#
# AP7 default-refuse: only peak-bones with hinge-magnitude axis-movement are
# eligible. b01c08 has one axis-move scene (scene-A; capability +0.5). Peak-
# bones in held scenes (@13, @15 in s02; @20, @23, @24 in s03) are quiet-
# peaks — default-refused without further analysis.
#
# Bone-by-bone evaluation of non-refused candidates:
#
# @6 (taylor traces the watcher-sightlines — hinge-magnitude; capability +0.5;
#   central event; sole axis-move bone):
#   Clears AP7 in principle (peak-bone; hinge-magnitude axis-movement).
#   Refused on three compounding grounds:
#   (1) AP3 NI-redundancy: interest-narrator:1 @6 already carries the
#       geometric-overlay figure ("her own overlay slots in above it, geometric
#       not contested"). A metaphor at @6 doubles what NI already renders.
#   (2) Functional-register failure + WATCH-1: The Khepri-echo at this bone
#       is reader-side recognition only. Taylor's prose is held at gap-noted /
#       geometry-filed / circuit-continues per scene-map protected-pattern
#       (WATCH-1: "consent" / "override" / "Khepri" must NOT enter Taylor's
#       prose). A callback metaphor connecting the sightline-trace to the
#       override-architecture would require Taylor to register the Khepri-
