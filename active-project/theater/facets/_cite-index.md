...
totals: 68 facet entries; 23/39 protolines decorated (59.0%)   # post-cycle-3: narrator:12 + sensory:1 + vibes:3 + vibes:9 deleted (DEC-0035); cycle-3-state-updates: state:6 anchor @26→@25 (fix-1); state:30 added @31 (fix-6)
...
### loc-state (6 entries)
  ...
  loc-state:4 @25 back=Y co=[sensory:3, state:5, state:6]
...
### narrator (10 entries)
  ...
  narrator:7 @31 back=Y co=[state:7, state:10, state:29, state:30]
...
### sensory (2 entries)
  ...
  sensory:3 @25 back=Y co=[loc-state:4, state:5, state:6]
...
### state (30 entries)
  ...
  state:5 @25 back=Y co=[loc-state:4, sensory:3, state:6]
  ...
  state:10 @31 back=Y co=[narrator:7, state:7, state:29, state:30]
  ...
  state:29 @31 back=N co=[narrator:7, state:7, state:10, state:30]
  state:30 @31 back=Y co=[narrator:7, state:7, state:10, state:29]
...
### feel (2 entries)
  feel:1 @7 back=Y co=[narrator:10, taylor-hebert-kl-122ac:4, vibes:1]
...
### exposition (3 entries)
  ...
  exposition:2 @14 back=N lic-out=[b01c01:4]
  exposition:3 @26 back=N lic-out=[b01c01:4]
...
- exposition:3 @26  `taylor-hebert-kl-122ac enters Roper's Court`

## Bare protolines (no citations accrued)
_Round-2 add candidates if the rubric licenses a fire here._

@2, @3, @8, @10, @12, @14, @16, @19, @20, @21, @23, @24, @26, @30, @33, @34
# cycle-3-state-updates: @26 newly bare (state:6 anchor moved to @25)
