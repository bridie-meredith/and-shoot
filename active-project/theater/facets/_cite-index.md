...
### loc-state (1 entry)
  loc-state:1 @1 back=Y co=[exposition:5]
...
### sensory (2 entries)
  sensory:1 @2 back=Y
  sensory:2 @9 back=Y
  # cycle-1 remediation 2026-05-25: sensory:2 anchor moved @16→@9; modality changed sound→tactile;
...
### state (5 entries; 4 deleted in cycle-1 remediation 2026-05-25)
  ...
  # DELETED state:5 @17 — posture, NI co-citation absent; re-add pending NI @17 (cycle-1)
  # DELETED state:6 @21 — social_tether_prot_axis: invented field + ledger-as-state (cycle-1)
  # DELETED state:8 @26 — ward-recognition: cross-POV authority violation + NI absent (cycle-1)
...
- sensory:2 @9  `the crowd compresses`
...
@5, @6, @13, @14, @15, @17, @19, @20, @22, @23, @25
