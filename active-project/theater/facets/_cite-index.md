...
### state (18 active entries; gaps at 11 [DELETED] and 17 [CUT])
  ...
  state:2 @2 back=Y co=[state:7]
  state:3 @5 back=Y co=[state:9]
  state:4 @13 back=Y
  state:5 @18 back=Y co=[state:13]
  state:6 @3 back=N co=[exposition:2, state:8, vibes:5]
  state:7 @2 back=N co=[state:2]
  state:8 @3 back=N co=[exposition:2, state:6, vibes:5]
  ...
  state:16 @25 back=N
  # state:17 CUT (cycle-2 fixer) — ID gap preserved
  state:18 @20 back=N co=[exposition:4, exposition:5, loc-state:4, vibes:19]
  state:19 @22 back=N co=[narrator:5a, state:14, vibes:14, vibes:15]
  state:20 @26 back=N co=[vibes:18, vibes:20]

### mem (3 entries)
  mem:1 @12 back=Y co=[narrator:3, vibes:8, vibes:11]
  mem:2 @23 back=Y co=[feel:1, meta:1, narrator:7, vibes:17] lic-in=[meta:1]
  mem:3 @8 back=Y co=[narrator:2, state:10]

### feel (2 entries)
  feel:1 @23 back=Y co=[mem:2, meta:1, narrator:7, vibes:17] lic-in=[meta:1]
  feel:2 @21 back=N co=[narrator:5, vibes:13]
...
### vibes (23 entries)
  ...
  vibes:16 @24 back=Y co=[narrator:6, state:15] lic-out=[proto:23, proto:24, proto:25]
  vibes:17 @23 back=Y co=[feel:1, mem:2, meta:1, narrator:7] lic-out=[proto:23, proto:24]
  vibes:18 @26 back=Y co=[state:20, vibes:20] lic-out=[proto:9, proto:20, proto:21, proto:26]
  vibes:19 @20 back=Y co=[exposition:4, exposition:5, loc-state:4, state:18] lic-out=[proto:20, proto:21, proto:26]
  vibes:20 @26 back=Y co=[state:20, vibes:18] lic-out=[proto:23, proto:24, proto:25]
...
- **@20** (5): exposition:4, exposition:5, loc-state:4, state:18, vibes:19
...
- state:4 @13  `the walls cool`
- state:16 @25  `taylor-hebert-kl-122ac speaks to wren-stitch-maker-flea-bottom-ward`
- vibes:6 @4  `coll-net-mender-flea-bottom extends the needle`
- vibes:9 @14  `taylor-hebert-kl-122ac handles the nets`
- exposition:1 @0  (preamble — expected lonely; exempt from deletion by rubric)
