...
1 taylor-hebert-kl-122ac enters the corner-room [state:9]
2 taylor-hebert-kl-122ac pays the building-keeper [state:10]
...
6 taylor-hebert-kl-122ac circles the block [state:11]
7 taylor-hebert-kl-122ac drops the pack [state:12]
8 coll-net-mender-flea-bottom speaks to taylor-hebert-kl-122ac [state:13]
...
13 taylor-hebert-kl-122ac threads the needle [state:14]
...
20 coll-net-mender-flea-bottom folds the net [state:15] [state:16]
...
25 taylor-hebert-kl-122ac speaks to wren-stitch-maker-flea-bottom-ward [state:17]
...
29 taylor-hebert-kl-122ac lifts the needle [state:18]
