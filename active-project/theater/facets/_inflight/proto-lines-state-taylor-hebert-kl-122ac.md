...
2 taylor-hebert-kl-122ac pays the building-keeper [state:2]
...
6 taylor-hebert-kl-122ac circles the block [state:3]
7 taylor-hebert-kl-122ac drops the pack [state:4]
8 coll-net-mender-flea-bottom speaks to taylor-hebert-kl-122ac [state:5]
...
13 taylor-hebert-kl-122ac threads the needle [state:6]
...
20 coll-net-mender-flea-bottom folds the net [state:7] [state:8]
...
25 taylor-hebert-kl-122ac speaks to wren-stitch-maker-flea-bottom-ward [state:9]
...
29 taylor-hebert-kl-122ac lifts the needle [state:10]
