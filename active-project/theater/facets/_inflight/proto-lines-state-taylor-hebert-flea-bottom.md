...
1 the beetles relay the cold candle
...
22 the beetles spread the apothecary ground floor [state:4][state:5]
...
26 taylor-hebert-flea-bottom wakes [state:7]
...
30 taylor-hebert-flea-bottom writes the entry [state:8]
...
40 the second clerk writes the entry [state:9]
41 the second clerk closes the record book
42 the second clerk releases the record book [state:10]
...
47 taylor-hebert-flea-bottom writes the entry [state:11]
...
59 taylor-hebert-flea-bottom speaks to the dock-side cluster
...
67 oc-tanner-elder places the coin [state:12]
68 taylor-hebert-flea-bottom closes the fist
69 taylor-hebert-flea-bottom opens the log
70 taylor-hebert-flea-bottom writes the entry [state:13]
...
93 taylor-hebert-flea-bottom writes the entry [state:14]
...
103 oc-tanner-elder speaks to taylor-hebert-flea-bottom [state:15]
104 taylor-hebert-flea-bottom faces oc-tanner-elder
105 taylor-hebert-flea-bottom exhales
...
114 the beetles spread the south-wall perimeter [state:17]
...
118 taylor-hebert-flea-bottom wakes [state:19]
...
123 taylor-hebert-flea-bottom writes the entry [state:20]
124 taylor-hebert-flea-bottom closes the log
125 taylor-hebert-flea-bottom faces the Red Keep [state:21]
126
...
133 the flies relay the messenger [state:22]
...
145 taylor-hebert-flea-bottom writes the entry [state:24]
...
155 the beetles spread the south-wall colony [state:25]
...
162 taylor-hebert-flea-bottom faces the wall [state:26]
163 taylor-hebert-flea-bottom opens the log
164 taylor-hebert-flea-bottom writes the entry [state:27]
