# proto-lines — b01c02 — annotated: location-state
# base: active-project/theater/proto-lines/b01-c02.md
...
aggregate_range: 1-47

1 the flies return the heat-signatures
2 the beetles return the threshold-count
3 taylor-hebert-kl-122ac leaves the drain angle [loc-state:1]
...
27 the insects file the ward-junction contact
28 the insects return the junction-lane attenuation
29 the insects reach the junction-lane edge [loc-state:8]

30 taylor-hebert-kl-122ac takes the drain angle [loc-state:9]
31 the insects return from the lane-mouth sweep
32 the shadow fills the drain angle [loc-state:10]
33 taylor-hebert-kl-122ac runs the map
34 the fever-cluster corner returns three bodies above ambient
35 the dark-junction corner returns the silence-pattern
36 the map returns the bodies
...
40 taylor-hebert-kl-122ac stalls the count
41 taylor-hebert-kl-122ac holds the breath
42 taylor-hebert-kl-122ac draws the line
43 taylor-hebert-kl-122ac closes against the drain angle
44 the accounting closes the fever-cluster entry [loc-state:11]
