...
1 @1 actor:taylor-hebert-kl-122ac.position: null -> flea-bottom-anonymous

# @1: Occupation established. Taylor's cover-work state initialized.
2 @1 actor:taylor-hebert-kl-122ac.occupation: null -> net-mender-flea-bottom-corner

# @7: Pack dropped. Inventory state change.
# The pack is set down at the working corner; Taylor's inventory shifts.
3 @7 actor:taylor-hebert-kl-122ac.inventory.pack: carried -> set-at-working-corner
...
4 @9 actor:taylor-hebert-kl-122ac.knowledge.ward-geometry: null -> flea-bottom-block-level-passive # field-extension: ward-geometry (b01c01 passive orientation layer)
