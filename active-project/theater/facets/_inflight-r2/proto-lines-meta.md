# proto-lines (R2 fork) — metaphor
# source: active-project/theater/proto-lines/b01-c01.md (locked R1 graph)
# R2 mutations: 0 KEEP-all (R1 zero-fire refusal stands; R2 reviewed @9/@18/@27 clusters per metaphor.md body section)
# citation cascade: no tokens stripped; no tokens added (metaphor.md remains 0-entry)
