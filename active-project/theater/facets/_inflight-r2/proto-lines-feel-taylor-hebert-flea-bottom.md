# proto-lines — s01e02
# R2 in-flight copy: feeling slice (taylor-hebert-flea-bottom)
# Body-integrity HARD RULE: only [feel:<id>] tokens for this slice cascade-change here.
# This R2 pass produced 0 adds and 0 deletes for taylor's slice — no cascade changes.
