...
# R2.3 annotated copy — oc-tanner-elder feeling slice
# Cascaded tokens for THIS character only:
#   @6   [feel:1]    -> [feel:2]    (consolidated id from _cite-index.md)
#   @131 [feel:2]    -> [feel:3]    (consolidated id from _cite-index.md)
# All other [feel:N] tokens on lines belonging to other characters (Taylor @15/@53/@145,
# maester @90, father @98) preserved byte-identical from the canonical proto-lines.
# SVO bodies byte-identical throughout.
