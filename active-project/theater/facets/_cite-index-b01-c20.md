...
### loc-state (7 entries)
  ...
  loc-state:2 @6 back=Y co=[sensory:2, state:5]
  loc-state:3 @14 back=Y co=[exposition:3, feel:2, narrator:4, state:12, state:26]
...
### state (32 entries)
  ...
  state:8 @10 back=Y co=[state:7]
  state:9 @12 back=Y co=[sensory:3, state:10]
  state:10 @12 back=Y co=[sensory:3, state:9]
  state:11 @13 back=Y
  state:12 @14 back=Y co=[exposition:3, feel:2, loc-state:3, narrator:4, state:26]
  state:13 @15 back=Y
  state:14 @16 back=Y
  state:15 @17 back=Y co=[state:27, vibes:4]
  state:16 @18 back=Y co=[exposition:2, loc-state:4]
  state:17 @19 back=Y
  state:18 @22 back=Y co=[narrator:5, vibes:5]
  state:19 @23 back=Y co=[loc-state:5]
  state:20 @25 back=Y co=[state:21, state:29]
...
### exposition (3 entries)
  ...
  exposition:2 @18 back=Y co=[loc-state:4, state:16]
  exposition:3 @14 back=Y co=[feel:2, loc-state:3, narrator:4, state:12, state:26]
...
- state:17 @19  `the smoke fills the east-of-water-gate lanes`
- exposition:1 @0  `[chapter-open preamble]`
