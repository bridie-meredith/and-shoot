...
#
# rubric-vibes.md §"Required gates" gate 2 (Op coherence) — Patch 1 pre-seeded note
#
# Carve-out scope: all + entries on loc:oc-stitch-house-lane
# Carve-out rule: loc:oc-stitch-house-lane carries no pre-seeded vibe-set (no actors/*/vibes.md
#   analog exists for locations; warehouse/oc-stitch-house-lane.md is a geography card only).
#   All ops on this target are fresh + (op coherence: keyword absent, satisfies gate 2 bullet 1).
# Coverage justification: location enters as an active surveillance base only in b01c02;
#   no prior episode vibes were authored for this location.
#
# Per-entry annotations: vibes:4, vibes:5, vibes:11 — all + on absent location keywords; carve-out confirms gate-2-pass.
...
4 @27 loc:oc-stitch-house-lane + surveillance-anchor: [coverage-base-for-forty-seven-bodies, drain-angle-as-observation-post, lane-mouth-as-threshold-data-point, physical-address-of-the-surveillance-architecture] | licensed-by: proto:27, proto:17, proto:18
...
9 @42 actor:taylor-hebert-kl-122ac ++ atonement-as-repetition: [line-drawn-twice-as-same-prohibition, recognition-suppressed-at-same-threshold-as-crossing, architecture-self-sealing-at-the-second-drawing] | licensed-by: proto:42, proto:41, proto:43

10 @47 actor:taylor-hebert-kl-122ac ++ cold-utilitarian interiority: [exhale-as-ledger-close-not-question-close, accounting-complete-weight-not-discharged, sealed-not-resolved] | licensed-by: proto:47, proto:44, proto:45, proto:46

11 @13 loc:oc-stitch-house-lane + multi-day-coverage-weight: [hook-ward-as-multi-day-sample-not-single-morning, foot-traffic-pattern-over-days-not-hours, architecture-outlasting-the-individual-sweep] | licensed-by: proto:13, proto:14, world-build:b01c02-chunk-multi-day-mapping
