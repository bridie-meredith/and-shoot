# bones — b01c01 (R2 fork) — feeling / coll-net-mender-flea-bottom
# source: active-project/theater/proto-lines/b01-c01.md (locked R1 graph)
# scope: Coll-subject anchors (@4, @5, @8, @12, @20); per-bone integrity preserves full file
# R2 mutations: 0 KEEP-all (zero-fire refusal stands; no R1 feel-coll entries to KEEP/DELETE; no adds)
