# proto-lines with [state:<id>] citations — env slice
# episode: b01c02
# source: active-project/theater/proto-lines/b01-c02.md (read-only; not mutated)
# citations: state-updates-env.md entries only (studio.* and prop:* scope)
# author: studio
...
20 taylor-hebert-kl-122ac takes the drain angle [state:1]
