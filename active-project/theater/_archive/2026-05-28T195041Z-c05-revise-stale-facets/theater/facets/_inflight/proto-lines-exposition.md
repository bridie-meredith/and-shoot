# proto-lines-exposition — b01-c05
# byte-identical SVOs from theater/bones/b01-c05.md with [expo:<id>] citations on fired anchors
# 3 fires / 31 bones (9.7%) + 1 @0 synthetic (prior-episode-bridge; renders pre-body)
# fires: @0 [expo:1] | @2 [expo:2] | @8 [expo:3]
# zero speech bones in chapter (dialogue-adjacency fence union ∅; cheap render-as permitted everywhere)
# scene-open-orient refusals: @1 (bridge-and-expo-and-bone-body carry) | @8 (continuity-refuse — no time-skip) | @20 (provisional clause-b loc-state expected-fire; R2 verifies)

# @0 [expo:1]  (synthetic anchor; prior-episode-bridge renders before body, italic-preamble)

1 the hill's stone skirt meets the lane-mouth
2 taylor-hebert-kl-122ac enters the rushwick [expo:2]
...
8 the courier enters the lane-mouth [expo:3]
