---
# VIBES — taylor-hebert-kl-122ac
# schema: schemas/memory.schema.md §Vibe-Cloud
# source: series vibe-cloud (memory.md) + card vibe seeds + condition cards
# scope: series/book level — active during authoring; book-level takes priority on key conflicts
---
...
VIBES:
  ...
  king's-landing: [stone-tallow-rain-smell, beauty-for-people-not-paying-attention, dense-insect-feed-requiring-suppression, the-wrong-accent-that-nobody-can-place]
  gold-morning: [the-ceiling-of-threat-recalibrated, everything-here-is-smaller, smaller-still-kills-people, the-thing-she-did-at-the-end]
  magic: [no-spectacle, only-residue, the-Westerosi-call-it-witchery, she-notes-the-vocabulary-delta-and-continues]
  earning-collapse: [three-auditable-mistakes-between-the-good-intention-and-the-cost, legible-in-retrospect-not-in-the-moment, the-second-answer-narrows-the-exits]
