# Exposition cross-episode register — taylor-westeros-good-intentions

Terms / objects / places / characters glossed in this project. Each entry blocks
re-glossing in future episodes (per rubric § Cross-episode register), modulo
the qualifier-exception.

Format: `- <key> | glossed-in: <episode> | gloss-id: <id> | first-mention-anchor: @<anchor>`
