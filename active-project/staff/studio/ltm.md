# studio LTM
# append-only log of significant set changes across the episode
...
11 location-state entries authored.
Environmental arc: dawn (chapter-open, drain-angle clear, tallow-lamps unlit) → morning (tallow-lamps on, smoke pooling, Hook-wide coverage active) → dusk (shadow fills drain-angle).
Parking-lot pl-2026-05-25-019 resolved: loc-state:7 @22 establishes alley-mouth as shared spatial frame; @23 inherits without re-citation.
Transition-run continuity-carry: loc-state:11 @44 (continuity-from loc-state:10; dusk-shadow holds through ledger-close run @44–@46).
