...
seasons:
  - slug: s01
    ...
    episodes:
      ...
      - slug: s01e03
        status: audited-r1-mechanical   # 2026-05-12: Phase 5 r2 CLEAN (0 HARD; 18 SIGNAL all advisory). r1 had 3 HARD (URI-CONSOLIDATION-CITE-DRIFT family: flag-001 feeling, flag-004 state-update, flag-014 vibes licensed-by); fixer cleared all 3 via systematic token-form rewrite (6 + 35 + 53 = 94 rewrites; mapping tables retained at active-project/staff/fixer/s01e03-*.md); cite-index rebuilt via build_cite_index.py --skip-merge. r2 audit at active-project/staff/auditor/facets-final-audit.md. Awaiting Phase 5b audience adversarial gate.
        narrator: taylor-hebert-flea-bottom
        interlude: false
