    ...
    chapters:
      ...
      - slug: b01c15
        ...
        substance_delta:
          ...
          axes_held:
            - axis: social_tether-prot-rise
              rationale: "RECONCILED (Phase 0 aggregate-read + Phase 5 auditor fault-001): aggregate is 8.5 (c12 overshoot of the ~8 ceiling); aggregate intent is c13-c15 HOLD. Peak already reached at c12; c15 holds at 8.5. The book-author's +0.5 prediction predates the c12 overshoot. Peak-confirmation is enacted as the tether's embedded weight made perceptible (gap-lane negative-shape), NOT a new structural addition."
            - axis: moral_framework
              rationale: "no new breach this chapter; framework holds at -2"
            - axis: position-prot-rise
              rationale: "position at peak; no new formalization; holds at 6.0 (aggregate-corrected per Phase 0 handoff_conflicts; handoff_in predicted 6.5)"
            - axis: moral_legibility_to_self
        ...
        scenes:
          - slug: b01c15s01
            status: scened
            chunk: |
              Taylor holds the passage-adjacent ward circuit [event: aemond-compound-eye-read] from a routine
              coverage position — two flies in the stone-lip above the outer-court approach, one in the
              corner-gutter of the passage-arch. It is the part of the coverage map that abuts the Red Keep
              servant-passage tier: not the court itself, but the ground the court's traffic crosses going down.
              She has touched this margin before; it has returned pages, laundresses, a wood-carrier with
              a cough he has carried for a week. Today it returns a boy. [image: boy-with-sapphire-eye]
              Aemond Targaryen, twelve years old, [event: aemond-court-exercise] brought out onto the
              outer-court ground for a swordsmanship exercise with a household master-at-arms. The sapphire
              in the left socket catches the morning flat and holds it differently from the eye beside it —
              the stone does not track, does not flinch when the drill-angle changes, [image: sapphire-fixed-against-moving]
              does not participate in the animal accommodation that living eyes make when a blade swings close.
              Taylor reads the posture across the compound-eye feed: the boy moves with something behind
              movement. [image: vhagar-behavioral-imprint] The gait-pattern is not a twelve-year-old's; the
              wide ground-check before each engagement, the angle of approach that accounts for a body much
              larger than the one on the court, the weight held ready in a way that presupposes clearance no
              ordinary yard provides. [mechanism: vhagar-behavioral-imprint-gait-read] The dragon's scale is
              in the boy's body before the dragon is on the yard. The master-at-arms adjusts the drill pressure
              downward at a particular moment — a visible accommodation, a man-sized reduction — and the boy
              does not accept it. [force: aemond-coercive-register] The correction that follows is not spoken
              aloud but is visible in the adjustment of the foot-position, the shoulder reset, the yield that
              happens in the other man's frame while the boy's frame stays level. Taylor watches a body that
              has never been told no at physical scale perform the grammar of receiving no-as-inadequate-theory.
              [image: coercive-register-visible-grammar] She does not route any of this to Jarvis. [mechanism:
              nothing-routed-to-jarvis] The apparatus does not need a twelve-year-old's sword drill. This is
              coverage terrain and she reads what is in it. What she reads does not change the cold
              contempt she has already settled on the people this boy is being shaped to stand among; it
              deepens that contempt by accumulation, not addition — one more specimen that fits the finding
              exactly. [force: taylor-cold-read] The sapphire catches flat light. The boy runs the correction again.
            scene_conflict:
              protagonist_force: >
                Taylor reads Aemond through the compound-eye feed with cold-utilitarian precision —
                the architecture returns what it returns; she does not intercept or withhold.
              opposing_force: >
                Aemond's coercive-register presence: a body already operating at the grammar of
                physical scale that cannot be refused, visible in the feed as structural pressure
            ...
            substance_delta:
              axes_in_motion:
                - axis: political_register-prot
                  ...
                  cost_ledger_anchor: null
                  notes: >
                    The Aemond court-exercise read through compound eyes deepens the articulated-contempt
                    register. Not a new threshold (that crossed at c13); this is the same contempt finding
                    a new specimen that exactly fits it. The coercive register in a twelve-year-old —
                    the grammar of receiving no-as-inadequate-theory — lands as confirmation of the
                    elite-formation Taylor already named. Accumulation within the band, not a new band.
                - axis: capability
                  direction: up
                  target_delta_magnitude: 0.5
                  cost_ledger_anchor: cl05
                  notes: >
                    The passage-adjacent ward read demonstrates coverage scope extended to Red Keep outer
                    margin — Taylor reads Aemond through a functional compound-eye anchor in a court-adjacent
                    location. cl05 gain-side final draw (first half); the architecture at this margin is
                    acknowledged load-bearing. No moral_framework cost — cl05 cost already paid at c12.
              axes_held:
                - axis: social_tether-prot-rise
                  rationale: >
                    Held at 8.5 (c12 overshoot; c13-c15 reconciled HOLD). Peak-confirmation is enacted
                    via the full-load context of Aemond's read, not a new structural node. The tether
                    carries its weight silently in the background of this scene.
                - axis: moral_framework
                  rationale: >
                    No new breach; holds at -2. Routing-nothing-to-Jarvis is a discipline enacted, not a
                    cost-entry. The rationalize-each-trade pattern is not tested here.
                - axis: moral_legibility_to_self
                  rationale: >
                    Holds at 6.0. Aemond-read routes to no one; the observation stays inside the
                    coverage record. No recognition event fires this scene.
              density_target: 0.75
          - slug: b01c15s02
            status: scened
            chunk: |
              The exercise ends. [event: exercise-ends] The boy is walked back up the passage-slope by
              the master-at-arms and two household servants, and the compound eyes in the court-margin lose
              him into stone. Taylor stays on the passage-adjacent ward. What arrives next is not in the
              feed as an image. [mechanism: vhagar-thermal-pressure-backwash] It is in the substrate: a
              thermal rise in the insect-bodies along the passage-arch gutter — the compound eyes do not
              process temperature the way mammal thermoreceptors do, but the flight-musculature on a fly in
              a warm airstream registers the airstream as motion-pressure, as changed resistance. [image:
              thermal-as-pressure-in-flight-musculature] Something large and warm is behind the stone. Not
              behind the ward — behind the hill. Vhagar's heat dissipates through the Red Keep's eastern
              slope in a way that is different from the bay-warm dissipating off the morning stone; the
              differential is detectable by a compound-eye architecture spread across the passage-arch
              because the arch is close to the substrate and the arch-flies are many. [mechanism: arch-fly-density-reads-differential]
              Taylor has learned this read over two months of coverage at this margin — the distinction
              between bay-warm and hill-warm, between the stone's own release and the added weight that
              comes when a dragon is resting on the eastern slope. [event: vhagar-proximity-read] Not a
              dragon on-stage. A thermal residue that has learned to mean something. [force: vhagar-pressure-as-background-instrument]
              The weight of the arrangement reaches its accounting here, in this reading: Otto's apparatus
              knows Taylor's architecture exists [mechanism: otto-leverage-structural]; the apparatus's awareness
              that the architecture exists — that Taylor identified the gap-lane courier eleven weeks before
              they found him independently — means the channel cannot be walked back. [event: non-extractable-confirmation-deepens]
              The tether is what holds the arrangement in place and the arrangement is what the apparatus
              runs. She reads Vhagar's footprint in the pressure-differential of a fly against warm stone
              and the full load of that architecture is in the same reading. [force: taylor-cold-read]
              The thermal rise normalizes over the next two minutes. She notes it in the internal record
              as a site-condition. She does not note what it confirmed.
            scene_conflict:
              protagonist_force: >
                Taylor reading the thermal/pressure backwash as a data point — the architecture returns
                what it returns, including the weight of what she cannot walk away from.
              opposing_force: >
                Vhagar's invisible presence (felt only as thermal residue in the fly-substrate) as the
                material form of the arrangement's full structural weight: the apparatus's leverage is
                now the same architecture as the insect-feed she reads.
              stakes_axis: social_tether-antag
            substance_delta:
              axes_in_motion:
                - axis: social_tether-antag
                  direction: up
                  target_delta_magnitude: 0.75
                  cost_ledger_anchor: cl-antag-d03
                  notes: >
                    The Vhagar-proximity read and the thermal/pressure residue mechanism are the physical
                    channel through which the non-extractable confirmation deepens to structural-completion.
                    The apparatus's independent identification of the gap-lane courier (cl-antag-d10, already
                    COMPLETE at c14) lands its full weight here: Taylor cannot walk back the architecture, and
                    the architecture cannot exist without the apparatus's awareness of it. First half of the
                    +1.5 social_tether-antag draw toward 9-LOCK. cl-antag-d03 final draw begun.
                - axis: capability
                  direction: up
                  target_delta_magnitude: 0.5
                  cost_ledger_anchor: cl05
                  notes: >
                    Vhagar-proximity read as a two-month-learned feed competency: the thermal/pressure
                    differential detection via arch-fly density. The architecture at the passage-adjacent
                    ward margin includes this site-specific read; the competency is acknowledged and load-
                    bearing. cl05 gain-side final draw (second half, completing cl05).
              axes_held:
                - axis: social_tether-prot-rise
                  rationale: >
                    Held at 8.5 (reconciled HOLD). The tether's full load is in the background of this
                    scene without a new structural node being added.
                - axis: position-prot-rise
                  rationale: >
                    Held at 6.0 (peak; cl-d07a COMPLETE at c14). No new position event.
              density_target: 0.80
          - slug: b01c15s03
            status: scened
            chunk: |
              The feed disruption at the ward's eastern edge is not uniform. [mechanism: feed-edge-degradation-under-vhagar-backwash]
              The thermal and pressure differential that marks Vhagar's footprint at the passage-arch does
              not arrive cleanly at the ward's periphery; it arrives as a fringe-effect, a slight compound-eye
              disorientation in the insect-bodies nearest the disrupted airstream. [image: compound-eye-fringe-degradation]
              The flies at the eastern edge of the passage-adjacent ward pick up more thermal-noise than the
              arch-flies — they are further from the heat source but closer to the ward-boundary where the
              coverage thins. The compound-eye feed from the eastern fringe reads as degraded: not dark, not
              interrupted, but carrying signal-interference that makes the image-resolution uncertain. [mechanism:
              fringe-fly-signal-interference] Taylor has run degraded coverage before. She knows the signature.
              What is different today — what has not been visible in the eleven months she has kept this
              architecture — is what the degradation illuminates. [event: gap-lane-negative-shape-emerges]
              The east-water-gate lanes do not show up in the degraded feed as covered-but-unclear.
              They show up as different from covered-but-unclear. [mechanism: absence-reads-as-negative-shape]
              The degraded signal at the fringe has a character — thermal-noise, resolution-dropout, known
              interference — and the east-water-gate gap has a different character entirely: no noise at all.
              Not interference. Not dropout. [image: clean-absence-against-noisy-fringe] A clean negative
              against the noisy fringe, the way a shadow reads against a lit wall: the absence is the shape,
              and the shape is perceptible. [force: wren-unmapped-presence-as-negative-shape] Because something
              moves there. Because Wren moves there. [event: wren-movement-in-gap-lanes] Taylor cannot see
              Wren in the gap-lanes — the coverage cannot reach that ground and has never reached it —
              but the gap reads now as a gap. The boundary has a shape it did not have before the backwash.
              [mechanism: disrupted-feed-makes-undisrupted-absence-visible] The lane-refusal Taylor wrote into
              the coverage record at c12 named the eastern boundary with two stone edges; she knew the gap
              was there and chose it. She has never been able to see the gap as a gap. Now it has a figure-ground
              relationship with what surrounds it: a clean window in noisy fringe, a nothing against something.
              [image: wren-as-negative-shape-in-coverage-architecture] This is not new information. Wren's free
              movement in those lanes is not a discovery — it is what Taylor built the eastern boundary to
              protect. The exclusion acquires a weight it did not carry before: no longer something Taylor knows
              abstractly in the accounting, but something the feed shows her — a negative space with a specific
              character and a person-shaped quality. [force: taylor-cold-read] Taylor does not open a new
              ledger entry. She holds the image — the clean absence against the noisy fringe — for the duration
              of a breath. She notes it in the coverage record as a site-condition variant: eastern-boundary,
              backwash-effect. She does not note what it looks like.
            scene_conflict:
              protagonist_force: >
                Taylor noting the gap-lane negative-shape as a site-condition variant in the coverage
                record — filing it in the architecture's terms without opening the ledger entry the
                shape implies.
              opposing_force: >
                The gap-lane negative shape itself: Wren's unmapped movement made perceptible as a
                person-shaped absence against the disrupted feed, demanding a name Taylor has eleven
                months of practice not writing.
              stakes_axis: relational_anchor_status
            substance_delta:
              axes_in_motion:
                - axis: relational_anchor_status
                  ...
                  cost_ledger_anchor: cl04
                  notes: >
                    The gap-lane negative-shape is the perceptual confirmation of the exclusion-pattern
                    that has been running since c02. The feed no longer merely knows Wren is absent from
                    the ledger — it now shows a person-shaped gap in the architecture, visible against
                    the degraded fringe. This is cl04's c15 draw (+1.5 of the +3.0 total; c14 drew +1.0,
                    this draws +1.5, a final +0.5 remains later). The gap going from invisible to perceptible
                    as a gap is the relational_anchor advance: the exclusion-pattern is now a feed-visible
                    negative shape, not an accounting-invisible omission. Taylor notes and does not enter.
                - axis: social_tether-antag
                  direction: up
                  target_delta_magnitude: 0.75
                  cost_ledger_anchor: cl-antag-d03
                  notes: >
                    The negative-shape perception completes the non-extractable confirmation: the architecture
                    that cannot be walked back now includes the visible gap — the thing Taylor chose not to
                    cover is perceptible as a choice. Second half of the +1.5 cl-antag-d03 final draw;
                    social_tether-antag reaches 9.0 (LOCK). The leverage is fully structural: the gap-shape
                    visible in the feed is the same gap Otto's apparatus routes around and the same gap Wren
                    moves freely through. All three pressures converge in one perceptual beat.
              axes_held:
                - axis: social_tether-prot-rise
                  rationale: >
                    Held at 8.5 (reconciled HOLD). The gap-shape perception confirms the tether's full-load
                    state — the negative shape is the tether's weight made visible — without adding a new
                    structural node.
                - axis: moral_framework
                  rationale: >
                    No new breach. Notes-and-does-not-enter is the same rationalize-each-trade pattern,
                    not a new threshold event. The framework holds at -2.
                - axis: moral_legibility_to_self
                  rationale: >
                    Holds at 6.0. The gap-shape is recognized in the feed but not in the ledger. The
                    crack is present; the recognition is suppressed (one breath, site-condition note,
                    no name set down). Full recognition remains deferred.
              density_target: 0.85
          - slug: b01c15s04
            status: scened
            chunk: |
              By the time the thermal backwash at the ward's eastern edge normalizes, the passage-adjacent
              ward is carrying no more anomalies. [event: feed-normalizes] The arch-flies settle; the
              fringe-interference clears; the eastern boundary returns to its ordinary state: clean coverage
              west, clean gap east, the two stone edges Taylor named in the record at c12 holding their
              positions. The negative shape has gone. It was visible for the duration of the backwash.
              Taylor closes the circuit and counts what the morning produced. [force: taylor-accounting]
              Aemond, twelve, a boy already shaped like the thing he will become. The sapphire holding flat
              light. The master-at-arms yielding without being asked. A thermal footprint in the fly-substrate
              that means a weight behind the stone. And, for the duration of a compound-eye fringe disruption,
              a gap with a person-shaped quality where there has always been just a gap. [image: tether-at-full-load]
              The accounting is not a ledger entry. It is a circuit-read, the kind she runs at the end of every
              coverage pass: what arrived, what it means, what it does not change. Aemond's arrival changes
              nothing she is doing. [event: aemond-routed-to-no-one] She is not routing information about a
              twelve-year-old to a patron. The coverage record has a site-condition note. The site-condition
              note will not become a delivery. [mechanism: nothing-enters-the-channel] This is the architecture
              at full load: it reads everything, it routes what the arrangement asks for, and it notes separately
              the things it will not route. The gap-lane gap has been in the second category since c12. [image:
              architecture-at-full-load] What changed today is that the second category has a visible shape.
              It is not invisible anymore. It is perceptible as a deliberate thing, a structure of not-covering,
              a lane she chose and holds with the same technical discipline she brings to the covered ground.
              [mechanism: deliberate-gap-structure-made-visible] The gap's new visibility does not change
              what she does with it; she has held it for eleven months. What it changes is the register:
              the thing is no longer nothing-visible-to-her. It is a named absence with a shape. [force:
              wren-as-named-absence] The accounting closes without a new entry for it. She pulls the feed
              back to routine coverage density and runs the afternoon circuit. The arrangement continues.
              [event: arrangement-continues-no-cascade]
            scene_conflict:
              protagonist_force: >
                Taylor closing the circuit — running the accounting that closes the morning's coverage
                pass without opening the ledger entry the gap-lane shape implies.
              opposing_force: >
                The named absence with a shape: the east-water-gate gap, now perceptible as a deliberate
                structure, holds the weight of Wren's exclusion as a visible thing rather than a nothing —
                a pressure that does not change what Taylor does and does not go away.
              stakes_axis: relational_anchor_status
            substance_delta:
              axes_in_motion: []
              axes_held:
                - axis: social_tether-antag
                  rationale: >
                    social_tether-antag has reached 9.0 LOCK (confirmed by S3's second-half draw). S4 is
                    the accounting close — no new leverage event, just the full-load state at rest. Held
                    at 9.0; LOCK confirmed; cl-antag-d03 complete.
                - axis: relational_anchor_status
                  rationale: >
                    Holds at 7.0 (post-S3 draw). The accounting close enacts the notes-and-does-not-enter
                    discipline; no further draw this scene. The gap-lane gap has a visible shape and is not
                    entered. This is the scene's substantive discipline: the advance already happened, the
                    scene is the moment before the cascade begins, not the cascade.
                - axis: social_tether-prot-rise
                  rationale: >
                    Held at 8.5 (reconciled HOLD). The tether-at-full-load image is the chapter's
                    peak-confirmation image. No new structural node.
                - axis: moral_framework
                  rationale: >
                    No breach; holds at -2. The accounting closes without a new entry.
                - axis: political_register-prot
                  rationale: >
                    Holds at 5.5 (post-S1 advance). Aemond-routes-to-no-one is the discipline enacted;
                    no new contempt-threshold event.
                - axis: capability
                  rationale: >
                    Holds at 7.5 (cl05 complete after S1+S2). No new deployment this scene.
                - axis: moral_legibility_to_self
                  rationale: >
                    Holds at 6.0. The accounting close is the suppression enacted: the gap has a shape,
                    the shape is not entered, the recognition is not let settle. Same pattern as c12/c14.
                - axis: position-prot-rise
                  rationale: >
                    Holds at 6.0 (peak; cl-d07a COMPLETE at c14). Aemond-routes-to-no-one confirms
                    the non-extractable position without creating a new position event.
              density_target: 0.70
        chunk_cold_read:
          reviewed_at: 2026-06-04T00:00:00Z
          verdict: SHIPPED-WITH-RISK-RECORDED
          classification: B
          recovered_summary: "A surveillance operative spends one morning reading a boy (Aemond), a hidden dragon's heat (Vhagar), and a deliberate blind spot in her own net (the gap-lane where Wren moves) flicker into view through her insect-feed — and decides, again, to do nothing about any of it."
          intended_goal: "Show the audience Aemond through compound eyes — the escalation engine in physical form, already coercive — and the tether at full load, so the falling arc reads as the space before the cascade begins."
          continue: no
          continue_strict: no
          report_path: (cold-read returned inline; summary preserved in memory)
          disposition: P
          dispositioned_at: 2026-06-04T00:00:00Z
          dispositioned_by: admin   # DEC-0087 (user-proxy)
          voice_risk:
            triggered: true
            signals: [B]
            central_event: "Aemond's coercive-register read through compound eyes (S1); Vhagar's thermal/pressure footprint in the fly-substrate (S2); the gap-lane reading as a clean negative shape against the noisy fringe where Wren moves unmapped (S3); the accounting close as a physical ledger-act, arrangement-continues (S4)."
            voice_risk_carry: |
              Class-B abstraction-density risk (accounting/feed register, same family as the b01c14 cold-read FAIL).
              /and-stitch Phase 8.5 Check 3 must verify these central events reach cold-reader legibility in
              assembled prose and are NOT muffled below the abstraction-vocabulary (feed/coverage/architecture/
              accounting nouns): (1) Aemond visible as a coercive body, not "court content"; (2) Vhagar's
              footprint felt as concrete thermal/pressure on the fly-substrate, not "a site-condition";
              (3) the gap-lane negative-shape rendered as a perceptual figure-ground contrast, not "the exclusion
              advances"; (4) S4 as a physical ledger-act/gesture, not a drawn conclusion.
          cold_read_risk_carry: |
            Principal (DEC-0087) authorized these cold-read complaint categories as known-risk for the chapter,
            armed forward to /and-stitch Phase 9: event-poverty (low on-page event count by design — falling
            accounting chapter); jeopardy-offstage (no on-page risk-to-person; the Dance/Otto-leverage pressure
            is structural/mediated by design); "nothing-changes" close (the arrangement-continues plateau is the
            falling-arc's correct shape per dramatist + dark-fantasy-reader). A Phase 9 FAIL Class-B with these
            SAME categories ships terminal as SHIPPED-WITH-CAVEATS automatically (no re-disposition). A Phase 9
      ...
      - slug: b01c17
        ...
        handoff_conflicts:
          # /and-substance chapter b01c17 Phase 0 (URI-AGGREGATE-READ): aggregate-state.md
          # (through_chapter b01c16) overrode book-author handoff_in prediction. aggregate wins.
          - detected_at: 2026-06-04T22:50:00Z
            axis: capability
            handoff_in_value: 7.0
            aggregate_value: 7.5
            resolution: aggregate-wins
          ...
          - detected_at: 2026-06-04T22:50:00Z
            ...
            resolution: aggregate-wins
        chunk_cold_read:
          reviewed_at: 2026-06-04T23:05:00Z
          verdict: SHIPPED-WITH-RISK-RECORDED   # CHUNK-CLASS-B dispositioned P (DEC-0094); arms /and-stitch Phase 9 Step 4 auto-ship
          classification: B
          recovered_summary: "A spy protects a friend by forging an innocent man into the enemy's files, and realizes she just did the exact thing she came here to stop doing."
          intended_goal: "Show the audience the protection and the Khepri-echo together — Taylor protecting Wren by deploying the override architecture she came here to retire — so the irony is explicit before it becomes catastrophic."
          continue: yes        # Q5 first-pass (marginal)
          continue_strict: no  # Q7 post-no-charity; AUTHORITATIVE for classification
          report_path: active-project/staff/reviews/chunk-coldread-b01c17-2026-06-04.md
          disposition: P
          dispositioned_at: 2026-06-04T23:05:00Z
          dispositioned_by: admin
          decision_ref: DEC-0094
          voice_risk:
            triggered: false
            signals: []
            central_event: "Taylor writes three false log-lines attributing Wren's east-of-water-gate movement-signature to Elder Norren, closing Otto's apparatus query and screening Wren."
          cold_read_risk_carry: |
            Class-B serial-midpoint family (cf. c14 DEC-0085 / c15 DEC-0087 / c16 DEC-0090),
            pre-authorized for SHIPPED-WITH-CAVEATS if Phase 9 recurs the same categories:
            event-poverty / "four scenes restate the same accounting" / withheld prior-chapter
            motive (Wren-relationship + override-architecture) is the deliberate Earth-Bet fence
            and c01-c16 reader context / jargon opacity (stitch-house, Hook, ward-read) /
            almost-no-physical-action-beyond-writing. The one genuine (non-uninformedness)
            signal — internal-ledger-recalculation over physical staging — is targeted by the
            converging /and-write enactment carries below. /and-stitch Phase 4+9 carry.
        scenes:
          - slug: b01c17s01
            status: scened
            chunk: |
              Jarvis returns his [event: gap-figure-query-delivered] weekly cipher-bundle in the
              usual way — a folded count-sheet tucked under the stone at the
              Fishmonger Gate water-trough, the agreed mark on the third column
              figure. Taylor retrieves it at dusk, reads it standing, and finds
              the query third from the bottom: [event: apparatus-pattern-query-received] a woman moving
              east of the water gate on a regular interval, footfall-pattern
              consistent across six observation points over eleven days, observed
              twice in proximity to ward contacts Jarvis's handler has already
              noted in Taylor's coverage zone. The apparatus wants to know who
              she is. [mechanism: gap-figure-query-shape] The query is pattern-only — no name, no
              description beyond height-and-gait, no indication that the
              apparatus knows what it is looking at. It is a gap in their
              picture and they have noticed the gap-figure using it. [force: protagonist]
              Taylor folds the sheet and stands at the trough and does not yet
              move. [image: trough-standing-still] She knows the answer before she has decided
              anything. The gait-pattern is [mechanism: wren-identification-instant]
              Wren's — the particular
              hesitation at the second step that comes from the scar tissue
              across her left ankle, the interval that matches the stitch-house
              rotation. Taylor has her own coverage data; she has been reading
              the east-of-water-gate gap in Jarvis's feed for months, knowing
              the gap-figure is Wren, never routing that knowledge anywhere it
              would surface. [force: opposing] The apparatus has now looked at the
              same gap from the other side and asked the same question Taylor has
              been refusing to answer.
            scene_conflict:
              protagonist_force: "Taylor receives the apparatus's pattern-query targeting Wren's
                movement corridor and reads its implications before any answer is formed"
              opposing_force: "the apparatus's pattern-recognition logic — a gap in the picture
                that the intelligence machinery is now pressing to fill; the question exists
                in Jarvis's channel regardless of whether Taylor answers it"
              stakes_axis: relational_anchor_status
            substance_delta:
              axes_in_motion: []
              axes_held:
                - axis: relational_anchor_status
                  rationale: "the apparatus query has named Wren-as-pattern; the identification
                    is Taylor's alone — she has not yet acted on it; the anchor weight does not
                    move until Wren is actually screened; this scene establishes that the question
                    has landed and Taylor has identified the answer, which is the precondition for
                    the cost to fire"
                - axis: capability
                  rationale: "Taylor's coverage data already contained the Wren-gait identification;
                    the capability that will deploy in s03 is established here as already-present;
                    held because the deployment has not occurred"
                - axis: moral_framework
                  rationale: "the prohibition is the background architecture against which the
                    apparatus question registers its weight; Taylor holds still at the trough —
                    the crack has not opened yet; this scene names the precipice, not the fall"
                - axis: moral_legibility_to_self
                  rationale: "Taylor knows the answer; the accounting has not opened on the choice
                    yet; legibility held at crack-level from c16 close — she can see the question
                    clearly but has not yet filed an entry"
                - axis: political_register-prot
                  rationale: "no contempt register events; this scene is Ward-level and
                    courier-channel; the apparatus is Otto's machinery but the query's content
                    is Flea Bottom geography, not court-tier conduct"
                - axis: social_tether-prot-rise
                  rationale: "the courier channel is the established tether mechanism; the tether
                    does not move at the delivery of a query; held at peak 8.5"
                - axis: social_tether-antag
                  rationale: "locked at 9; the apparatus using the courier channel for a use-vector
                    query is Otto's leverage doing its structural work, not a new leverage event"
                - axis: position-prot-rise
                  rationale: "Taylor's position is what made Jarvis's channel available; the scene
          ...
          - slug: b01c17s02
            status: scened
            chunk: |
              Taylor does not go back to the stitch-house. [image: night-ward-walk] She walks
              the Hook's southern edge in the dark, reading the ward's density
              through her feet, and lets the accounting run. [mechanism: ledger-calculation-sequence]
              The apparatus question
              has a cost: [force: opposing] if she routes a description of Wren to Jarvis,
              Wren becomes a named person in Otto's picture — a smallfolk woman
              who moves through a coverage gap in a pattern that has already
              attracted scrutiny. Named means findable. Findable means usable.
              Taylor runs the price out to its terminus and the terminus is
              exposure. The counter-option also has a cost: [event: screen-option-recognized]
              she can route
              a different figure through the gap documentation — attribute the
              gap-movements to a different ward-elder, someone whose presence in
              that corridor has a plausible read that closes the question. This
              option protects Wren. [force: protagonist] Taylor prices it honestly:
              it inserts a false record into Otto's intelligence picture. It
              attributes movements to a person who did not make them. It places
              a ward-elder in a pattern-profile that will now accumulate future
              observations. [mechanism: false-attribution-price] The ward-elder is not Wren, which
              is the gain. The ward-elder did not choose this, which is the cost.
              Taylor runs both entries and the accounting does not resolve. She
              holds the question open and keeps walking. [image: second-step-hesitation-recalled]
              Wren's second-step
              hesitation surfaces in her memory without being summoned — not an
              argument, just the specific weight of a specific gait — and the
              [event: override-architecture-recognition-begins] recognition she has been
              not-opening begins to form at the
              edge of her accounting: the option that protects Wren is
              structurally indistinguishable from the architecture she built
              her coming-here to be the refusal of.
            scene_conflict:
              protagonist_force: "Taylor prices the two options — name Wren to the apparatus,
                or route a different figure through the gap documentation — and runs both
                entries in her ledger"
              opposing_force: "the internal accounting itself: the screen option's mechanism
                is false attribution applied to a person without their knowledge or consent —
                the cost side of the protection is exactly the shape Taylor came here to retire"
              stakes_axis: moral_framework
            substance_delta:
              axes_in_motion:
                - axis: moral_framework
                  ...
                  target_delta_magnitude: 0.5
                  cost_ledger_anchor: cl03a
                  notes: "the crack opens as a ledger recognition, not yet as an act; Taylor
                    cannot unname the structural equivalence between the screen option and the
                    override architecture; the framework's crack-level deepens from c16's
                    behavioral-withdrawal form (walked away from Halvard) into explicit
                    accounting-recognition form; cl03a cost side is approaching completion —
                    the intelligence-network-build is about to roll over into use-deployment;
                    -0.5 reflects crack-deepening, not the full breach; the full -0.5 fires
                    in s03 when the act occurs"
              axes_held:
                - axis: moral_legibility_to_self
                  rationale: "legibility held at crack-level; Taylor is running the accounting
                    accurately — she can name the structural equivalence — but does not open
                    the full recognition event; she holds the question open and keeps walking;
                    the c17 chapter contract specifies legibility holds at crack-level and does
                    not open full recognition; that full opening belongs to a later delta"
                - axis: relational_anchor_status
                  rationale: "anchor pressure does not move in this scene; Wren is named in
                    Taylor's accounting as the figure requiring protection, but the protection
                    has not landed; no screen has occurred; held until s04 when the screen's
                    consequence settles on Wren's side"
                - axis: capability
                  rationale: "the capability to execute the screen is established but has not
                    deployed; Taylor is pricing the option, not yet implementing it; held for s03"
                - axis: political_register-prot
                  rationale: "no court-tier content; this is entirely internal-accounting and
                    ward-level; the contempt register has no material to form on in this scene"
                - axis: social_tether-antag
                  rationale: "locked at 9; the options are internal to Taylor; Otto's leverage
                    is not a new event here"
                - axis: position-prot-rise
                  rationale: "position held; the scene's work is interior, not positional"
                - axis: social_tether-prot-rise
                  rationale: "tether held at peak 8.5; this scene does not alter the tether
                    structure; the collapse axis will fire in s03 but the tether itself does
                    not move here"
              density_target: 0.70-0.80
            stale_since: null
            event_map:
          ...
          - slug: b01c17s03
            status: scened
            chunk: |
              [event: deployment-decision-enacted] Before the Hook turns north Taylor has
              already decided, because the accounting has been running long enough
              and there is no version of the ledger where letting Wren become a
              named figure in Otto's picture costs less than the alternative.
              She does not record the decision. [mechanism: false-record-insertion]
              She goes back to her
              room — the space above the tallow-render works that she rents for
              three coppers a week — and pulls the coverage log for the
              east-of-water-gate corridor. The log is in her own hand: a running
              tally of movement signatures, timestamped by light-quality, no
              names because she never writes names. She selects [event: ward-elder-substitution]
              the entry-cluster that matches Wren's interval — eleven days, six
              observation points — and attributes the signature to Elder Norren,
              a tanner's-ward contact whose legitimate passage through that
              corridor twice a week gives the attribution a plausible read.
              [mechanism: feed-routing-adjustment] In the morning she will add three
              supplementary observations
              to Norren's entry-cluster, dated backward, calibrated to the
              gait-interval the apparatus has already flagged. The addition will
              be indistinguishable from a coverage gap that closed on its own.
              [event: query-closure-prepared] When she routes the updated log segment to Jarvis's
              dead drop, the apparatus's gap-figure will resolve as a tanner's-ward
              elder whose movements have a mundane explanation, and the question
              will close. [force: opposing] Taylor writes the supplementary entries. [force: protagonist]
              Three lines in her own hand, attributing to Elder Norren a presence
              in the east-of-water-gate corridor that belongs to Wren. [image: pen-on-log-three-lines]
              The pen is the instrument. The log is the record. This is what
              [event: capability-deployment-and-khepri-echo-co-fire] protection looks like at single-person scale —
              routing a body through
              a coverage map without their knowledge or consent, substituting one
              person's pattern for another's, adjusting the record so the apparatus
              reads what Taylor needs it to read. [mechanism: override-architecture-parallel]
              The shape of the act
              is the shape of the thing she built her prohibition against. She
              does not close the log entry. She leaves the pen beside it.
            scene_conflict:
              protagonist_force: "Taylor writes the false attribution — three lines in her own
                hand inserting Elder Norren into the east-of-water-gate pattern to close the
                apparatus's query and screen Wren from its picture"
              opposing_force: "the override architecture she is enacting: routing a person
                through a coverage map without their consent, adjusting the record to produce
                a desired read — the prohibition's precise target, deployed at single-person
                scale as protection"
              stakes_axis: capability
            substance_delta:
              axes_in_motion:
                - axis: capability
                  direction: up
                  target_delta_magnitude: 1.0
                  cost_ledger_anchor: null
                  notes: "the network-adjustment at single-person scale is the capability
                    deployment the chapter's contract names; Taylor routes a different figure,
                    attributes gap-movements to a different ward-elder — the concrete act is
                    on-page; network capability now encompasses deliberate record-modification
                    and false-attribution routing, not only passive observation; this is the
                    first use-deployment of the intelligence network at a named individual's
                    protection (not the first network action, but the first explicit override
                    of the record on a named person's behalf); no cost_ledger_anchor because
                    the capability gain here is subsumed by cl03a's cost-side completion — the
                    gain is structural, the anchor fires on moral_framework"
                - axis: moral_framework
                  direction: down
                  target_delta_magnitude: 0.5
                  cost_ledger_anchor: cl03a
                  notes: "cl03a cost side completes: the intelligence-network-build rolls over
                    into use-vector-deployment; the third material breach; Taylor writes three
                    false lines in her own hand, attributing a person's movements to another
                    person; the moral_framework crack from s02 (accounting-recognition) becomes
                    an enacted breach; Taylor cannot unname this in her own ledger; -0.5 here
                    completes the chapter's -1.0 total on moral_framework; the pen is on the
                    page — the act is irreversible"
                - axis: position-prot-collapse
                  direction: down
                  target_delta_magnitude: 1.0
                  cost_ledger_anchor: cl07b
                  notes: "collapse axis ACTIVATES; the protection deployment is the first event
                    the collapse narrative claims; Taylor's position-of-no-exit is now also a
                    position-of-record-manipulation — she has modified the intelligence picture
                    Otto's apparatus relies on; the non-exit deepens because extraction would
                    now require Taylor to also resolve the false attribution; the collapse arc
                    has its first allocation: 7 → 6; cl07b gain-side (position-world +2) is
                    not a chapter-17 event — the collapse axis fires on the cost side of that
                    ledger entry"
                - axis: social_tether-prot-collapse
                  direction: down
                  target_delta_magnitude: 1.0
                  cost_ledger_anchor: cl07a
                  notes: "collapse axis ACTIVATES; the tether that holds Taylor inside Otto's
                    architecture now includes a modification of the intelligence feed that tether
                    depends on; the first allocation of the tether's downward arc: 8 → 7; the
                    tether's load-bearing quality is unchanged but the false attribution is now
                    a structural element of the tether — an unwind would require resolving what
                    Taylor has written; cl07a gain-side (moral_legibility_to_self +4) is not
                    a chapter-17 event — the collapse axis fires on the cost side"
              axes_held:
                - axis: moral_legibility_to_self
                  rationale: "Taylor cannot unname the override echo but does not open the full
                    recognition event; she leaves the pen beside the log — a held gesture that
                    enacts the crack without completing the recognition; legibility remains at
                    crack-level per chapter contract; the chapter does not advance to full
                    recognition (that belongs to a later delta)"
                - axis: relational_anchor_status
                  rationale: "the screen is written but not yet delivered; the anchor weight
                    rises when the protection actually lands — when Jarvis routes the updated
                    log and the apparatus's question closes; held until s04"
                - axis: political_register-prot
                  rationale: "no court-tier content; this scene is entirely Ward-level record-work;
                    the contempt register has no material here"
                - axis: social_tether-antag
                  rationale: "locked at 9; the apparatus is Otto's machinery but this scene's
                    event does not change Otto's leverage posture — he does not know the record
                    has been adjusted"
                - axis: social_tether-prot-rise
                  rationale: "the collapse axis fires (social_tether-prot-collapse) but the rise
                    axis itself is held at peak 8.5; these are distinct axes per RISE-THEN-COLLAPSE
          ...
          - slug: b01c17s04
            status: scened
            chunk: |
              Three days later the dead drop returns nothing. [event: apparatus-query-closes]
              The apparatus's question
              has resolved: Elder Norren's east-of-water-gate movements are in
              the picture now, attributed and closed. No follow-up query. No
              flag. [event: wren-screened-confirmed] Wren moves through the corridor as she has
              always moved, and the apparatus does not know her name. [image: wren-second-step-interval]
              The second-step hesitation crosses the morning ward-read the way it
              always does — the scar-tissue interval that Taylor has been reading
              for months — and now there is a false record in Otto's intelligence
              picture that the interval belongs to Norren. [force: protagonist]
              Taylor does not enter
              this into the cost-ledger. [mechanism: ledger-non-entry] She knows what the ledger
              entry would say: protection delivered, Wren screened, one ward-elder
              inserted into a pattern-profile without his consent or knowledge.
              [event: false-attribution-now-structural] Elder Norren will accumulate future observations.
              Future queries
              may arrive. The false attribution is not a single event; it is a
              structural feature of the record now. Taylor runs the accounting
              in her head and does not write it down. [force: opposing] The column that
              would hold this entry stays blank. [image: blank-ledger-column]
              The protection worked.
              The architecture that worked is the architecture she came here to
              retire: [event: irony-made-explicit] routing a body through a record without their
              knowledge, adjusting what the apparatus reads, moving a person
              through an intelligence picture to produce a desired outcome at
              single-person scale. She protected Wren the same way she built
              the thing she came here to atone for — not the scale, not the
              number of persons, but the shape of the act. She keeps the
              accounting in her head where it will not exist on paper.
              [image: wren-in-corridor-morning] Wren crosses the morning ward-read and Taylor
              does not route her name anywhere it will surface, and this is called
              protection, and the ledger is blank, and both facts are true.
            scene_conflict:
              protagonist_force: "the protection has landed — Wren is screened, the apparatus's
                query is closed, the anchor weight rises to 7.5 (cl-d11 delivered)"
              opposing_force: "the irony that cannot be unnamed: the false attribution now sits
                structural in the record, the collapse axes have their first allocation, and the
                ledger column Taylor refuses to fill is the exact column that names what she
                has done; the blank is the accounting"
              stakes_axis: relational_anchor_status
            substance_delta:
              axes_in_motion:
                - axis: relational_anchor_status
                  ...
                  target_delta_magnitude: 0.5
                  cost_ledger_anchor: cl-d11
                  notes: "cl-d11 delivers: the apparatus's query is closed, Wren is screened,
                    the anchor weight rises from 7.0 to 7.5; the gain side of cl-d11 lands here —
                    Taylor intercepts the use-vector targeting the cost-bearer and adjusts the
                    network to screen it; the protection succeeded; the cost side (opportunity-missed:
                    same override architecture she built to atone for) fires alongside — the gain
                    and the cost are the same event; relational_anchor_status rises because Wren
                    is now inside a false record that protects her, which is exactly the cost
                    the axis is designed to register (un-priced anchor now load-bearing inside
                    a falsified record)"
              axes_held:
                - axis: moral_framework
                  rationale: "moral_framework has completed its chapter movement (-1.0 across s02+s03);
                    this scene holds at the new floor (-3.0 aggregate); the irony is named but
                    the framework does not move further in this chapter — the recognition is
                    crack-level, not the irrevocable breach; that belongs to a later delta"
                - axis: moral_legibility_to_self
                  rationale: "the ledger column is blank; Taylor runs the accounting in her head
                    and does not write it; legibility held at crack-level — she cannot unname
                    the echo, but the full recognition event is deferred; the blank column is
                    the enacted form of legibility-held: she sees clearly and does not file"
                - axis: capability
                  rationale: "capability has completed its chapter movement (+1.0 at s03);
                    this scene confirms the protection succeeded — no additional capability
                    deployment; held at 8.5"
                - axis: position-prot-collapse
                  rationale: "collapse axis has completed its chapter movement (-1.0 at s03);
                    this scene shows the structural consequence of the collapse allocation
                    (the false attribution is now permanent in the record) but does not
                    move the axis further; held at 6.0"
                - axis: social_tether-prot-collapse
                  rationale: "collapse axis has completed its chapter movement (-1.0 at s03);
                    the false attribution is now a structural feature of the tether's
                    architecture; no further collapse allocation in this chapter; held at 7.0"
                - axis: political_register-prot
                  rationale: "no court-tier content; the protection event is ward-level and
                    record-internal; the contempt register has no material in this scene"
                - axis: social_tether-antag
                  rationale: "locked at 9; the apparatus's query closed without Otto learning
                    the gap-figure was Wren or that the record was adjusted; his leverage
                    posture is unchanged"
                - axis: social_tether-prot-rise
                  rationale: "rise axis held at peak 8.5; collapse has its first allocation
                    but the rise axis does not move further; distinct axes per contract"
                - axis: position-prot-rise
                  rationale: "held at 6.0; the screening deployment does not advance Taylor's
                    position in Otto's apparatus — she resolved a query through Jarvis's channel
