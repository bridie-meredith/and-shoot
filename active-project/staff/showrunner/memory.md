  ...
  - slug: b01
    ...
    chapters:
      - slug: b01c01
        ...
        status: audited-r1-mechanical    # 2026-05-23 Phase 5 mechanical audit + cycle-2 fixer + post-audit adjudication + rubric edit + cycle-2 audience-gate + pulp-enthusiast taste-arbiter override complete (HARD=0, 9 SIGNAL). Phase 5b cycle 2 COMPLETE post-arbitration: 9 ACCEPT (6 cleared 3-of-3 + 3 deferred-with-attribution via arbiter) / 3 FAIL. Cycle-3 fixer dispatch scope: 3 tractable facets (interest-narrator content recast narrator:5/7; vibes:2 license trim + vibes:5/7/8/9 token replacements; dialogue-coll facet-license cross-anchor @8). No high-risk ADDs required. Cap is 3 cycles (URI-FACETS-CAP-BURN-SEMANTICS A2); cycle 3 is the last remediation budget.
        ...
        audience_gate_facets_passed: [dialogue-wren-stitch-maker-flea-bottom-ward, location-state, state-updates, feeling, metaphor, exposition]    # 6 facets cleared 3-of-3 (1 carried from cycle 1 + 5 cleared in cycle 2)
        ...
        audience_gate_facets_failed: [interest-narrator, vibes, dialogue-coll-net-mender-flea-bottom]    # 3 facets fail cycle 2 post-arbitration; require cycle-3 remediation (all tractable: NI content recast / vibes token + license trim / dialogue-coll facet-license cross-anchor)
