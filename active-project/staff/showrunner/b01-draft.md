# b01 draft — /and-substance book b01 (Phase 2 + 3 + 4)
# Generated: 2026-05-24
# Chapters: 20 (per book.structure.chapter_count)
# User/admin: review YAML; type `accept` to persist to memory.md books[b01].{drama, chapters[]}.
...
# === ROLL-UP CHECK ===
# Per-axis sum of target_delta_magnitude across all 20 chapters vs. book target.
# Tolerance: ±1 rank. Direction: per axis (down axes summed as absolute magnitude).
#
# axis                      | book target | chapter sum | drift | status
# --------------------------|-------------|-------------|-------|--------
