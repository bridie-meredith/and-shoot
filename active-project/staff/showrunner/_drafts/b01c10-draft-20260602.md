# SUPERSEDED-by-memory 2026-06-02 — persisted to chapters[b01c10].scenes (memory.md). Archival copy.
# b01c10 scene chunks — /and-substance chapter Phase 2+3
# Authored: 2026-06-01
# Chapter contract source: memory.md lines 5632–5735
# Roll-up: all 7 axes_in_motion sum to chapter targets (see per-scene notes below)
