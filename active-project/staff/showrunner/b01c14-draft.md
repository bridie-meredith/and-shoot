    ...
    substance_delta:
      axes_in_motion:
        - axis: relational_anchor_status
          ...
          notes: "cl04 partial: ledger entry opened and written — one named person, closed without knowledge, chosen explicitly; the closure is recorded as an explicit breach-column entry; cl04 first half complete"
        - axis: social_tether-antag
          direction: up
          target_delta_magnitude: 0.5
          cost_ledger_anchor: cl-antag-d10
    ...
    substance_delta:
      axes_in_motion:
        - axis: relational_anchor_status
          ...
          target_delta_magnitude: 0.5
          cost_ledger_anchor: cl04
          notes: "cl04 COMPLETES: figure detained, outcome recorded, closure retroactively naming the Wren omission via shared column-logic — the un-entered item visible in the adjacent format; cl04 closed"
        - axis: social_tether-antag
          direction: up
          target_delta_magnitude: 0.5
          cost_ledger_anchor: cl-antag-d10
