# Season 1 Plan — "The Steward's Note"
# ~84–88 AC (Taylor age 7–11 in body)
# Written by screen-writer. Accepted after two internal review iterations.

---

## A. Season Title and Time-Window

**"The Steward's Note"** — ~84–88 AC. Taylor arrives in body at age 7 (~84 AC) and closes the season at age 10–11 (~87–88 AC). The season spans approximately four years.

---

## B. Season Drama

A reincarnated organizer spends two years building an invisible operational baseline inside a world too small to hide in forever, then loses her invisibility in a single involuntary act at the market square — and the four years that follow are the long cost of what gets built under the steward's growing file and what gets paid by the people she cannot keep at managed distance before a stranger in maester's robes arrives at Fairstead with someone else's letter in his bag.

---

## C. Season Question

What does Taylor build in the window between arriving unknown and becoming named — and what does she give up, without choosing to, to the people she was supposed to be a daughter and neighbor to, before the institutional clock crosses its first tier?
...
## F. Cast Usage by Episode (Matrix)

| Episode | Lead | Supporting |
|---------|------|-----------|
| s01e01 | taylor-hebert-jaehaerys | oc-craftsman-father (Edwyn), oc-craftsman-mother (Elara) |
| s01e02 | taylor-hebert-jaehaerys | septon-rowan, oc-craftsman-mother (Elara, background) |
...
## G. Stage Usage by Episode (Matrix)

| Episode | Primary Location | Secondary |
|---------|-----------------|-----------|
| s01e01 | loc-craftsman-workshop-home | westerosi-smallfolk-dwelling-interior, westerosi-smallfolk-village-common |
| s01e02 | loc-local-sept | loc-craftsman-workshop-home |
| s01e03 | loc-market-square | westerosi-smallfolk-village-common |
| s01e04 | loc-river-ferry-dock | westerosi-smallfolk-village-common |
| s01e05 | loc-market-square | westerosi-smallfolk-village-common, loc-river-ferry-dock (Pryor's approach) |
| s01e06 | loc-market-square (wool-factor's stall, alley behind) | westerosi-smallfolk-dwelling-interior |
| s01e07 | loc-local-sept | loc-craftsman-workshop-home |
| s01e08 | loc-river-market-town (composite: sept, workshop district, market) | loc-craftsman-workshop-home, loc-local-sept |

---

## H. New Stage Elements Introduced in S1

**New actor introduced at episode level:**
- `oc-maester-traveler` — the lord's traveling maester; no name assigned at season-plan level; walk-on functional role; introduced in s01e08; does not join the series cast roster (his role closes at season end as the note passes through him); Margit provisions as a walk-on prop-actor if needed or episode-plan handles him as an atmospheric presence.

**No new location cards required for S1.** All eight episodes use stage elements already listed in the series-plan (loc-river-market-town, loc-craftsman-workshop-home, loc-market-square, loc-local-sept, loc-river-ferry-dock, westerosi-smallfolk-village-common, westerosi-smallfolk-dwelling-interior). The wool-factor's stall and alley behind it (s01e06) are sub-locations of loc-market-square and do not require a new card.

---

## I. Structural Notes for Episode-Plan Authoring

- **Active cost ceiling at episode level:** Child-body ceiling applies throughout S1 (ten minutes active control → headache; twenty → nosebleed; thirty → blackout). s01e05 is the only episode with an active swarm event; all other episodes use passive-sense only. Shoot-phase must mark the ceiling on s01e05's episode-plan explicitly.
