...
The insects returned a body the map had no slot for — a woman crossing the same thresholds on the same sweeps, day after day, returning as a junction-signature where the foot-traffic knotted. Neither a sick body nor a hungry one, neither one that stopped at the threshold-stones nor one that did not. The flies and beetles had a category the map had not written yet. The hands kept the count even.
...
The insects returned the function-signature — the body that knotted the junction, the body the alleys gave onto, the body the map was about to name. The map assigned the connector-type. The slot was the only language the map had.

I turned from the alley-mouth.

The insects filed the ward-junction contact.

The gesture moved in a hand that knew the motion, from another accounting under another architecture, and the hand kept going. The ledger had a new entry and no signature against it.
